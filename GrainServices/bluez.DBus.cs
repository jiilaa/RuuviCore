...
namespace bluez.DBus
{
    ...
    [DBusInterface("org.bluez.SimAccess1")]
    interface ISimAccess1 : IDBusObject
    {
        Task DisconnectAsync();
        Task<T> GetAsync<T>(string prop);
        Task<SimAccess1Properties> GetAllAsync();
        Task SetAsync(string prop, object val);
        Task<IDisposable> WatchPropertiesAsync(Action<PropertyChanges> handler);
    }

    [Dictionary]
    class SimAccess1Properties
    {
    ...
    static class SimAccess1Extensions
    {
        public static Task<bool> GetConnectedAsync(this ISimAccess1 o) => o.GetAsync<bool>("Connected");
    }
    ...
    public class Device1Properties
    {
        ...
        private byte[] _AdvertisingFlags = default (byte[]);
        ...
        private IDictionary<byte, object> _AdvertisingData = default (IDictionary<byte, object>);
        public IDictionary<byte, object> AdvertisingData
        {
            get
            {
    ...
    static class Device1Extensions
    {
        ...
        public static Task<IDictionary<byte, object>> GetAdvertisingDataAsync(this IDevice1 o) => o.GetAsync<IDictionary<byte, object>>("AdvertisingData");
